...
const String ADD_PRODUCT_TO_CART_URL="checkout/cart/add/"; //PRODUCTID, QUANTITY
...
const String APPLY_COUPON_URL="checkout/cart/coupon";  // MOTHOD POST  TAKE CODE
const String DELETE_COUPON_URL="checkout/cart/coupon";// MOTHOD DELETE  TAKE CODE
