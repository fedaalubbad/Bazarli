...
//
//     final moveToCartResponse = moveToCartResponseFromJson(jsonString);

import 'dart:convert';

MoveToCartResponse moveToCartResponseFromJson(String str) => MoveToCartResponse.fromJson(json.decode(str));

String moveToCartResponseToJson(MoveToCartResponse data) => json.encode(data.toJson());
...
class MoveToCartResponse {
  ...
  factory MoveToCartResponse.fromJson(Map<String, dynamic> json) => MoveToCartResponse(
