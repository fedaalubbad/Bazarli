...
class ProductDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    body: Stack(
      children: [
        ProductToolBar(productName: product.name,),
        Container(
      ...
      children: [
        ...
        Positioned(
          ...
          child: Column(
            ...
            children: [
              CircleAvatar(
                child: SvgPicture.asset('assets/svg/fav.svg',width: 12.h,height: 11.h,),
                backgroundColor: WhiteColor,radius: ScreenUtil().radius(12),),
              SizedBox(height: 10.w,),
              CircleAvatar(
                child: SvgPicture.asset('assets/svg/share.svg',width: 12.h,height: 11.h,),
                backgroundColor: WhiteColor,radius: ScreenUtil().radius(12),),
            ],
          ),
        ),
        ...
        children: [
          Row(children: [
            Container(
              margin: EdgeInsets.only(left: 20.w,right: 20.w),
                height:80 ,width: 80,
                child: Image.network(product.baseImage.originalImageUrl,fit: BoxFit.cover,)
            ),
            Container(
              width: 0.6.sw,
              child: Text(product.name,style: ProductTitleStyle,maxLines: 2,),
            )
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Text('modelNo',style: TextLabelStyle),
          ...
          Container(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Text('Saving',style: TextLabelStyle),
                Row(
                  children: [
                    Container(
                    ...
                    Container(
                        ...
                        child: Text('80% off',style:DiscountOffStyle,)),
                  ],
                ),
              ],
            ),
    ...
    crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(
          ...
          child: Text('Measures',style: TabsTextStyle,).tr(),
        ),
  ...
  getColors(){
    return Column(
      ...
      children: [
        Container(
          margin: EdgeInsets.symmetric(horizontal: 20.w),
          child: Text('Colors',style: TabsTextStyle,).tr(),
        ),
        SizedBox(height: 10.h,),
